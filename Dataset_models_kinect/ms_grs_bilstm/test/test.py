...
# Training & Evaluation
def train_and_evaluate(X_train, X_test, y_train, y_test, label_encoder, scaler, save_path=MODEL_SAVE):
...
if __name__ == "__main__":
    ...
    # Train and evaluate
    model, history, cm = train_and_evaluate(X_train, X_test, y_train, y_test, le, scaler, save_path=MODEL_SAVE)
    # Plot
