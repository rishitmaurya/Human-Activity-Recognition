...
output_dir = r'wearable_sensors/lstm_wear/testing'
...
#=========================================================
# 5. MODEL ARCHITECTURE (PURE LSTM)
# =========================================================
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        x, _ = self.lstm2(x)   # (B, T, 32)
        # x = self.attention(x) # (B, 32)
        x = x.mean(dim=1)
...
# 10. SAVE EVERYTHING
# =========================================================
torch.save(model.state_dict(), os.path.join(output_dir, 'final_model_bilstm.pt'))
